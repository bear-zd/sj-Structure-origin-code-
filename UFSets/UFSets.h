...
//____________________________要求1，即a为b的双亲___________________
template <class ElemType>
...
//____________________________要求1，即a为b的双亲___________________
template <class ElemType>
int UFSets<ElemType>::Height(ElemType e) const
{
        int height=1,temp=0;
        for(int j=0;j<size;j++)
        {
            if(e==e)
                {
                temp=1;
                temp=(temp>Height(j)?temp:Height(j));
                }
        }
        return height+temp;
}
